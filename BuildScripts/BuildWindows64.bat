@echo off
echo ================================================
echo      SynthMind Windows 64-bit Build Script
echo ================================================
echo.
...
set LOG_FILE="%PROJECT_PATH%\BuildLogs\build_log_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~0,2%%time:~3,2%%time:~6,2%.txt"
...
:: Execute Unity build
%UNITY_PATH% -batchmode -quit -projectPath "%PROJECT_PATH%" -executeMethod %BUILD_METHOD% -logFile %LOG_FILE% -profile Release -version 1.0.0
